...
namespace Ninesky.Models
{
    ...
    public class User
    {
        ...
        /// </summary>
        [Display(Name="QQ号码")]
        [RegularExpression("^[1-9]{1}[0-9]{4-13}$",ErrorMessage = "×")]
    ...
    public class UserRegister : User
    {
        ...
        public User GetUser()
        {
            return new User { Address = this.Address, Email = this.Email, Gender = this.Gender, GroupId = this.GroupId, Password = Common.Sha256(this.Password), PostCode = this.PostCode, QQ = this.QQ, RegTime = this.RegTime, SecurityAnswer = this.SecurityAnswer, SecurityQuestion = this.SecurityQuestion, Tel = this.Tel, UserName = this.UserName };
        }
    }
